...
router.put('/:id', authorize(), upload.single("image"),updateSchema, update);
...
function update(req, res, next) {
    userService.update(req.params.id,{firstName : req.body.firstName , lastName:req.body.lastName , username:req.body.username , password:req.body.password , image: '/static/' + req.file.filename})
